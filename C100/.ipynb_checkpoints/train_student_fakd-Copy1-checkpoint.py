...
parser.add_argument('--tcheckpoint', default='/root/autodl-tmp/cifar_teachers/resnet56_vanilla/ckpt_epoch_240.pth', type=str,
...
parser.add_argument('--layer-weight', default=[1, 1, 1, 1], type=list, help='the layer weight of network')
