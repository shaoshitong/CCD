...
CUDA_VISIBLE_DEVICES=1 python C100/train_student_fakd.py --checkpoint-dir ./store/ \
  --gpu-id 1  --i 2 --data /home/sst/dataset/c100 --arch wrn_16_2_fakd --tarch wrn_40_2   \
