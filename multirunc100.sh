python C100/train_student_singleppkd.py      --checkpoint-dir ./store/   --gpu 0  --i 3

#python C100/train_student_singleppkd.py      --checkpoint-dir ./store/       --gpu 0  --i 2
...
#python C100/train_student_augment.py   --arch wrn_16_2   --checkpoint-dir ./store/     --data D:/Product/data    --gpu 0  --i 2
